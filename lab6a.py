...
class Student:
    ...
    def __init__(self, name, number):
        self.name = name
        self.number = str(number)  # Ensure number is always treated as a string
        self.courses = {}
    ...
    # Calculate the GPA and handle zero division gracefully
    def displayGPA(self):
        try:
...
if __name__ == '__main__':
    ...
    student2 = Student('Jessica', 123456)  # Accepting int as number
